...
(function($){
	...
	$.fn.Xslider=function(settings){
		...
		this.each(function(){
			...
			scrollobj.find("li:eq(1)").addClass('cur_pro');//第二个为选中状态
			...
			btnleft.click(function(){
				...
				if(!moving){
					...
					if(settings.loop=="cycle"){
						...
						scrollobj.find("li:eq("+numtoMove+")").addClass('cur_pro').siblings().removeClass('cur_pro');//左翻页
				...
				if(!moving){
					...
					if(settings.loop=="cycle"){
						var callback=function(){
							...
							scrollobj.find("li:eq("+numtoMove+")").addClass('cur_pro').siblings().removeClass('cur_pro');//右翻页
